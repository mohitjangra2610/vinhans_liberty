        ...
        {stats.map((item) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="text-lg md:text-xs font-bold text-foreground mt-2 wrap-break-words">
                {item.number}
              </h3>

              <p className="mt-2 text-sm md:text-base text-muted-foreground font-medium line-clamp-2">
                {item.title}
              </p>  
