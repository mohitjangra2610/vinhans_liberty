  ...
  <div style="background:#005bc8;padding:32px 16px;font-family:Arial,sans-serif;">
    <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e0e0e0;">
      ...
      <div style="background:#0a1628;padding:28px 32px;display:flex;align-items:center;gap:12px;">
        <div style="width:36px;height:36px;background:#c9a84c;border-radius:4px;display:inline-flex;align-items:center;justify-content:center;">
          <img src="https://americanwealthcorp.com/aws_icon.svg" width="40" height="40" alt="AWC" style="display:block;" />
        </div>
        <div style="display:inline-block;margin-left:12px;">
          <p style="color:#ffffff;font-size:15px;font-weight:600;margin:0;letter-spacing:0.3px;">American Wealth Corp</p>
      ...
      <div style="padding:32px;">
        ...
        <div style="background:#f8f8f5;border:1px solid #e8e4d8;border-radius:6px;padding:24px;text-align:center;margin-bottom:28px;">
          ...
          <p style="font-size:12px;color:#c9a84c;margin:10px 0 0;font-weight:500;">Valid for 10 minutes</p>
        </div>
        ...
        <div style="border-left:3px solid #c9a84c;padding-left:14px;margin-bottom:28px;">
          <p style="font-size:13px;color:#666;margin:0;line-height:1.6;">
            Never share this code with anyone. American Wealth Corp will never ask 
